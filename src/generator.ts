...
export class Generator {
  ...
  protected async getTableTemplateInput(table: Table, tableKind: TableKind, filePath: string) {
    ...
    const exportRowTypes = this.opts.export?.rowTypes 
      ? ({} as any) 
      : false;
    ...
    const exportColMapping = (this.opts.export?.columnTypeMappingInterface || repo)
      ? ({} as any) 
      : false;
  ...
  protected getRepoInput(tableName: string, tableKind: TableKind, pkField?: FieldTmplInput) {
    ...
    return {
      className: this.getCrudRepoNameFromTableName(tableName),
      methods,
    }
  }
  ...
  protected getCrudRepoNameFromTableName(tableName: string) {
    return this.naming.crudRepositoryClassNamePrefix + this.getPascalCasedTableName(tableName) + this.naming.crudRepositoryClassNameSuffix;
  }
